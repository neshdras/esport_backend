...
const { createTeams, addPlayer, joinTeam, removePlayer, seeInfo, profileUpdate, profile, seeTeam } = require('../controllers/userController')
...
// US-17
router.get('/info/team/:id', seeTeam)
// US-18
